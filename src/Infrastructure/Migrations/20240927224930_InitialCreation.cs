        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FromCurrencyName = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    ToCurrencyCode = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: false),
                    ToCurrencyName = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    ExchangeRate = table.Column<decimal>(type: "decimal(19,6)", nullable: false),
                    BidPrice = table.Column<decimal>(type: "decimal(19,6)", nullable: false),
                    AskPrice = table.Column<decimal>(type: "decimal(19,6)", nullable: false),
